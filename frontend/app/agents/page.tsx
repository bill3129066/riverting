            ...
            {displayed.map(agent => {
              ...
              return (
                <Link
                  ...
                  className="group grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 items-start py-8 border-b border-border-subtle hover:bg-surface-dim transition-colors px-4 md:px-8 cursor-pointer"
                >
                  ...
                  <div className="md:col-span-2 flex flex-col h-full justify-between">
                    ...
                    <div className="flex justify-end mt-6">
                      <div className="bg-text-primary text-surface px-8 py-3 text-xs uppercase tracking-widest font-bold group-hover:bg-accent transition-colors flex items-center gap-2">
                        View Agent
